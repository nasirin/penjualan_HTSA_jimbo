                ...
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="frontend/img/featured/feature-1.jpg">
                        <ul class="featured__item__pic__hover">
                            <li><a href="frontend/#"><i class="fa fa-shopping-cart"></i></a></li>
                        </ul>
                    </div>
                    <div class="featured__item__text">
                        <h6><a href="frontend/#">Crab Pool Security</a></h6>
                        <h5>$30.00</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="frontend/img/featured/feature-2.jpg">
                        <ul class="featured__item__pic__hover">
                            <li><a href="frontend/#"><i class="fa fa-heart"></i></a></li>
                            <li><a href="frontend/#"><i class="fa fa-retweet"></i></a></li>
                            <li><a href="frontend/#"><i class="fa fa-shopping-cart"></i></a></li>
                        </ul>
                    </div>
                    <div class="featured__item__text">
